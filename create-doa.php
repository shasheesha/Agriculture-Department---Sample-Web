...
if (isset($_POST['next-btn2'])) {
    ...
    $_SESSION['user-category'] = $_POST['user-category'];
    ...
    <section class="login-sec secs">
        <form name="signUp" action="" method="POST" required>
            <div class="panel" id="page1">
                <p class="title">DOA Account Create</p>
                <p class="description">create with your details</p>
            ...
            <div class="panel disable" id="page2" action="" method="post" required>
                ...
                <select class="input-field cont-type" id="user-category" name="user-category">
